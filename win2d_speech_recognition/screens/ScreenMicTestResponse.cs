...
namespace win2d_speech_recognition {
    static class ScreenMicTestResponse {
        ...
        public static void Update(CanvasAnimatedUpdateEventArgs args) {
            if (BackgroundWords.Count < 10) {
                BackgroundWords.EnqueueRandomMicTestResponseWords(10);
            }
        ...
        public static void Reset() {
            str = new PuzzleAnimatedString(_device, new string[] { "I heard: " + Statics.RandomMicTestWord(), "Is this accurate?" }, false);
            str.Refresh();
